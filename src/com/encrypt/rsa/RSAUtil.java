...
//        requestDemo();
    ...
    private static Map<String,Object> uploadFileByHTTP() throws IOException {
        Map<String,Object> resultMap = new HashMap<String,Object>();
        String sURL = "http://localhost:10400/api/file/upload";
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpPost uploadFile = new HttpPost(sURL);
        uploadFile.setHeader("charset", "utf-8");
        MultipartEntityBuilder builder = MultipartEntityBuilder.create();
        builder.addTextBody("appId", "JK12a0d704342f11e9acc7525400397443", ContentType.TEXT_PLAIN.withCharset("utf-8"));
        builder.addTextBody("time", "123", ContentType.TEXT_PLAIN.withCharset("utf-8"));
        builder.addTextBody("fileType", "1", ContentType.TEXT_PLAIN.withCharset("utf-8"));
        builder.addTextBody("encrypt", "2", ContentType.TEXT_PLAIN.withCharset("utf-8"));
        builder.addTextBody("contentType", "test", ContentType.TEXT_PLAIN.withCharset("utf-8"));



        // 把文件加到HTTP的post请求中

        FileBody img1 = new FileBody(new File("D:\\配置\\1.jpg"));
        builder.addBinaryBody("fileStream", img1.getFile(), ContentType.MULTIPART_FORM_DATA.withCharset("utf-8"), "1.jpg");

        FileInputStream fileInputStream = new FileInputStream(img1.getFile());
        String md5 = DigestUtils.md5DigestAsHex(fileInputStream);

        String str = "appId=JK12a0d704342f11e9acc7525400397443&contentType=test&encrypt=2&fileStream=" + md5 + "&fileType=1&time=123";
